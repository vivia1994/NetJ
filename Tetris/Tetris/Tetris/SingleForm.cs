...
namespace Tetris
{
    public partial class SingleForm : Form
    {
		...
		Form startForm = null;
        public SingleForm(string username,int score,Form startForm)
        {
		...
		public SingleForm(Form startForm)
		{
			this.startForm = startForm;
			InitializeComponent();
		}
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                scoreBestName.Visible = false;
                scoreBest.Visible = false;
            }
        ...
        private void Btn_NewGame_Click(object sender, EventArgs e)
        {
            ...
            label8.Text = "下蛋还剩：" + num.ToString() + "次";
        }
